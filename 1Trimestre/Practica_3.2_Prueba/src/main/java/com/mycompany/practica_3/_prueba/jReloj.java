...
public class jReloj extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRelojDigital1.setAlarma(new jreloj.propiedadAlarma(new java.util.Date(1636651920000l),true));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jReloj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
